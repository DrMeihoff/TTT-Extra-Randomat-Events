CreateConVar("randomat_recoil_max", 15, {FCVAR_NOTIFY, FCVAR_ARCHIVE} , "Maximum Magnitude a gun can chnge somones velocity by.", 1, 100)
CreateConVar("randomat_recoil_mul", 6, {FCVAR_NOTIFY, FCVAR_ARCHIVE} , "Recoil Multiplier", 1, 100)

local EVENT = {}
EVENT.Title = "Realistic Recoil"
EVENT.Description = "Bullets are now a form of locomotion."
EVENT.id = "recoil"
